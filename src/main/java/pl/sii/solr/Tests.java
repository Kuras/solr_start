...
//        query.addSortField( "price", SolrQuery.ORDER.asc );
    ...
    protected void assertNumFound( String query, int num ) throws IOException, SolrServerException {
        QueryResponse rsp = SiiSolrServer.getSolrClient("demo").query( new SolrQuery( query ) );
